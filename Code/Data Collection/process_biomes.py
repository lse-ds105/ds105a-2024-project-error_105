...
def authenticate_earth_engine():
    """
    Authenticate with Google Earth Engine. Prompts the user for authentication if needed.
    """
    try:
        # Initialize the Earth Engine library (will fail if not authenticated)
        ee.Initialize()
        print("Successfully initialized Earth Engine.")
    except ee.EEException:
        print("Authentication required. Redirecting to authenticate...")
        ee.Authenticate()
        ee.Initialize()
